...
W1=np.zeros((LC,KC))
U=np.zeros((LC,KC))
U1=np.zeros((LC,KC))#n-1时刻
V=np.arange((LC,KC))
V1=np.arange((LC,KC))#n-1时刻
H1p=np.arange(LC)
H1p=Hp.copy()
H2p=Hp.copy()
H1u=np.arange(LC)
...
VHDX=np.zeros((LC,KC))
VHDX[:]=0
UHDY1=np.zeros((LC,KC))
UHDY1[:]=0
VHDX1=np.zeros((LC,KC))
VHDXE1[:]=0
UHDY2=np.zeros((LC,KC))
VHDX2=np.zeros((LC,KC))
U2=np.zeros((LC,KC))
V2=np.zeros((LC,KC))
W2=np.zeros((LC,KC))
UHE=np.arange(LC)
...
gb.set_value('H2u',H2u)
gb.set_value('H1v',H1v)
gb.set_value('H2v',H2v)
gb.set_value('UHDYE',UHDYE)
gb.set_value('VHDXE',VHDXE)
gb.set_value('UHDYE1',UHDYE1)
gb.set_value('VHDXE1',VHDXE1)
